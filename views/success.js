$(function() {
  $.get('/getData', function(datum) {
    if(datum=="An error occurred"){
      ...
      $('p#deets').prepend('<img src="//chart.googleapis.com/chart?cht=lc&chtt=Data&chs=250x150&chd=t:'+datum[1][1]+'&chxt=x,y&chxs=0,c0c0c0,10,0,lt|1,c0c0c0,10,1,lt&chco=000000" />');
    }
  });
});